...
const NoticePage = () => {
  ...
  return (
    <div className="w-full h-[900px] bg-white flex flex-col justify-center items-center">
      <div className="w-full h-16 pl-[11px] pr-[15.60px] pt-[17px] pb-[26px] flex justify-between items-center">
        <div className="w-[77.40px] h-[13px] relative"></div>
      </div>
      ...
      <div className="w-full flex-1 flex flex-col items-center overflow-y-auto">
        ...
        {openNotice === 'notice' && (
          <div className="w-[341px] text-neutral-400 text-sm font-medium leading-tight py-3 bg-stone-50 border-t border-b border-neutral-300">
            ...
            <br />
            <br />
            점검이 진행되는 동안에도 게시글/댓글 쓰기, 읽기 등 대부분의 기능을 이용하실 수
            있으나, 좋아요, 조회수 정보 미반영, 댓글 삭제 등 일부 기능에 영향이 있을 수
            있습니다.
            <br />
            <br />
